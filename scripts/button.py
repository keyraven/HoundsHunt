...
class Button(Interactable):
    ...
    def __init__(self, rect:pygame.Rect, text:str, text_renderer:pygame.Font, groups = (), antialias:bool = True, 
                 theme:dict = None, layer = 0, hotkey = None, id = None, visible:bool = True):
        super().__init__(rect, groups=groups, hotkey=hotkey, theme=theme, layer=layer, visible=visible, id=id)
